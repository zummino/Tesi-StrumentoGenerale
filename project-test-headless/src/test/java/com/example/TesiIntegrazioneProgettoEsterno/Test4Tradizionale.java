package com.example.TestSuiteProvaSpost2;
...
public class Test4Tradizionale {
  ...
  @Test
  public void testTradizionale_v_2_1() throws Exception {
    ...
    driver.findElement(By.xpath("//as-nav-bar-playlist/ul/li/a")).click();
