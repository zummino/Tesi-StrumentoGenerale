package com.example.TestChangeAttr2;
...
public class Test9Tradizionale {
  ...
  @Test
  public void testTradizionale_release_5_1() throws Exception {
    ...
    driver.findElement(By.xpath("//a[@id='buttonSearch']")).click();
