...
private static StringBuffer verificationErrors = new StringBuffer();
  ...
  public void test_loc_Rel_release_1_1() throws Exception{
    ...
    Thread.sleep(5000);
    driver.findElement(By.xpath("//input[1][@id='login-username']")).click();
    driver.findElement(By.xpath("//input[1][@id='login-username']")).clear();
    driver.findElement(By.xpath("//input[1][@id='login-username']")).sendKeys("odoobnb@gmail.com");
    driver.findElement(By.xpath("//input[1][@id='login-password']")).click();
    driver.findElement(By.xpath("//input[1][@id='login-password']")).clear();
    driver.findElement(By.xpath("//input[1][@id='login-password']")).sendKeys("provaprova93");
    driver.findElement(By.xpath("//button[1]/div[1]/span[1]")).click();
