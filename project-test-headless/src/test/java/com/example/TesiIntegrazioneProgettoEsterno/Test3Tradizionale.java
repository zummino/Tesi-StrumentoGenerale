package com.example.TestSuiteProvaSpost;
...
public class Test3Tradizionale{
  ...
  @Test
  public void testTradizionale_v_2_0() throws Exception {
    ...
    driver.findElement(By.xpath("//as-nav-bar-playlist/ul/li[3]/a")).click();
