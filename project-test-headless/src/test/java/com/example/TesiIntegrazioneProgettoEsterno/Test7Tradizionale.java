...
public class Test7Tradizionale {
  ...
  @Test
  public void testTradizionale_v_4_0_0() throws Exception {
    ...
    driver.findElement(By.cssSelector("div.user-dropdown.ant-dropdown-trigger")).click();
