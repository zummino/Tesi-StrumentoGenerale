package com.example.TestChangeAttr;
...
public class Test8Tradizionale {
  ...
  @Test
  public void testTradizionale_versione_5_0() throws Exception {
    ...
    driver.findElement(By.id("bottoneRicerca")).click();
