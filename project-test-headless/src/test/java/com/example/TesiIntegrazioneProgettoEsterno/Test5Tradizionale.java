package com.example.TestSuiteMoveTmplt1;
...
public class Test5Tradizionale {
  ...
  @Test
  public void testTradizionale_v_3_0() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='HomePage'])[1]/following::a[1]")).click();
